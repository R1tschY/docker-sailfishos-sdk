...
%packages
patterns-sailfish-configuration-sdk-build-engine
patterns-sailfish-hw-adaptation-x86-common
patterns-sailfish-sdk-build-engine
...
cp -f /mnt/mer-tooling-chroot $INSTALL_ROOT/
%end
